...
def decode(
    ...
    for work_element in value["value"]["values"]:
        ...
        try:
            ...
            print(f"Warning: failed to decode work {work_type}, keeping raw bytes: {e}")
        for work_assign in work_element["WorkAssignMap"]["value"]:
            ...
            try:
                ...
                print(f"Warning: failed to decode work assign, keeping raw bytes: {e}")
    return value
...
def encode(
    ...
    for work_element in properties["value"]["values"]:
        work_type = work_element["WorkableType"]["value"]["value"]
        if "values" not in work_element["RawData"]["value"]:
        ...
        for work_assign in work_element["WorkAssignMap"]["value"]:
            if "values" not in work_assign["value"]["RawData"]["value"]:
